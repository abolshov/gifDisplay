...
cmsRun CSCEventDisplay.py mc=true l1=true run3=true runCCLUTOTMB=true runME11ILT=true saveEdmOutput=false doGEMCSC=true inputFiles=file:/eos/user/y/yumeng/CMSSW_13_0_3/gifDisplay/27a95851-6358-485b-b15b-619f3404d795.root  plotdir="./plots/temp" eventListFile="eventList_yumeng.txt"