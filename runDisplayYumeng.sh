...
cmsRun CSCEventDisplay.py mc=true l1=true l1GEM=false run3=true runCCLUTOTMB=true runME11ILT=true saveEdmOutput=false doGEMCSC=true inputFiles=file:/eos/cms/store/group/upgrade/GEMCSC_Trigger_PhaseII/Phase2Spring24_DYtoLL50_00d881de-dccf-4232-b4a7-39083949f5fd.root plotdir="./plots/temp" eventListFile="badeventList_Ph2Spring24DY50_type0.txt"

# cmsRun CSCEventDisplay.py mc=true l1=true l1GEM=false run3=true runCCLUTOTMB=true runME11ILT=true saveEdmOutput=false doGEMCSC=true inputFiles=file:/eos/cms/store/group/upgrade/GEMCSC_Trigger_PhaseII/Phase2Spring24_DYtoLL50_00d881de-dccf-4232-b4a7-39083949f5fd.root plotdir="./plots/example" eventListFile="badeventList_Ph2Spring24DY50_type0.txt"
# cmsRun CSCEventDisplay.py mc=true l1=true l1GEM=false run3=true runCCLUTOTMB=true runME11ILT=true saveEdmOutput=false doGEMCSC=true inputFiles=file:/eos/cms/store/group/upgrade/GEMCSC_Trigger_PhaseII/Phase2Spring24_DYtoLL50_00d881de-dccf-4232-b4a7-39083949f5fd.root plotdir="./plots/example_type2" eventListFile="badeventList_Ph2Spring24DY50_type2.txt"
# cmsRun CSCEventDisplay.py mc=true l1=true l1GEM=false run3=true runCCLUTOTMB=true runME11ILT=true saveEdmOutput=false doGEMCSC=true inputFiles=file:/eos/cms/store/group/upgrade/GEMCSC_Trigger_PhaseII/Phase2Spring24_DYtoLL50_00d881de-dccf-4232-b4a7-39083949f5fd.root plotdir="./plots/example_type1" eventListFile="badeventList_Ph2Spring24DY50_type1.txt"
...
#cmsRun CSCEventDisplay.py mc=true l1=true run3=true runCCLUTOTMB=true runME11ILT=true saveEdmOutput=false doGEMCSC=true inputFiles=file:/eos/user/y/yumeng/CMSSW_14_2_0_pre1/gifDisplay/Devin_forYumeng/pickevents.root plotdir="./plots/temp" eventListFile="/eos/user/y/yumeng/CMSSW_14_2_0_pre1/gifDisplay/Devin_forYumeng/pickevents.txt"
